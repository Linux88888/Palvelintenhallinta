...
Tätä ohjetta on helppo hyödyntää omien skriptien ja pakettien asennukseen virtuaalikoneelle mikäli tälläiseen kokee tarvetta. Git komentoja voi käyttää myös lokaalisesti luomalla itselleen tarvittat .sls asennust tiedostot ja ottaen huomioon järjestelmän omat vaatimukset. 
