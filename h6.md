...
# Lentokenttien sää tiedot projekti https://github.com/hautadata/palvelintenhallinta-jh-moduuli/blob/main/h7-moduuli.md
...
Suoritus onnistuu ja dataa siirtyy. Tässä olisi myös seuraava osa, jossa dataa kerättäisiin euroopan kymmeneltä suurimmalta kentältä (Sama menetelmä kuin edellä), mutta kun on jo koko viikonlopun ajan käynyt eri töitä läpi ja tehnyt tehtävät niin nyt on aika siirtyä nauttimaan ulkoilmasta.
